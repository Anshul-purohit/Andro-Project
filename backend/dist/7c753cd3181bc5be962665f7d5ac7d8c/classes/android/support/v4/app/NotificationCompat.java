...
public class NotificationCompat
{
  ...
  public static class Builder
  {
    ...
    private void setFlag(int paramInt, boolean paramBoolean)
    {
      ...
      for (flags |= paramInt;; flags &= (paramInt ^ 0xFFFFFFFF))
      {
        return;
        localNotification = mNotification;
      }
    ...
    public Notification build(NotificationCompat.Builder paramBuilder)
    {
      ...
      for (;;)
      {
        ...
        else if ((mStyle instanceof NotificationCompat.BigPictureStyle))
        {
          ...
          localNotificationCompatJellybean.addBigPictureStyle(mBigContentTitle, mSummaryTextSet, mSummaryText, mPicture);
        }
      }
    }
  }
