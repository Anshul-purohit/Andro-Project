  ...
  extends Activity
{
  ...
  LoaderManagerImpl getLoaderManager(int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    LoaderManagerImpl localLoaderManagerImpl = (LoaderManagerImpl)mAllLoaderManagers.get(paramInt);
    if (localLoaderManagerImpl == null) {
      if (paramBoolean2)
      {
        localLoaderManagerImpl = new LoaderManagerImpl(this, paramBoolean1);
        mAllLoaderManagers.put(paramInt, localLoaderManagerImpl);
      }
    }
    for (;;)
    {
  ...
  void invalidateSupportFragmentIndex(int paramInt)
  {
    if (mAllLoaderManagers != null)
    {
      ...
      if ((localLoaderManagerImpl != null) && (!mRetaining))
      {
        ...
        mAllLoaderManagers.remove(paramInt);
      }
    }
  }
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    if (mAllLoaderManagers != null)
    {
      int k = mAllLoaderManagers.size() - 1;
      i = j;
      if (k >= 0)
      {
        localObject2 = (LoaderManagerImpl)mAllLoaderManagers.valueAt(k);
        if (mRetaining) {
          j = 1;
        }
        for (;;)
  ...
  protected void onStart()
  {
    ...
    for (;;)
    {
      ...
      {
        LoaderManagerImpl localLoaderManagerImpl = (LoaderManagerImpl)mAllLoaderManagers.valueAt(i);
