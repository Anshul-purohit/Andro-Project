  ...
  public boolean sendBroadcast(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      synchronized (mReceivers)
      {
        ...
        localObject1 = paramIntent.getScheme();
        ...
        if ((paramIntent.getFlags() & 0x8) != 0)
        {
          ...
          if (i != 0)
          {
            ...
            Log.v("LocalBroadcastManager", "Resolving type " + str2 + " scheme " + (String)localObject1 + " of intent " + paramIntent);
          }
        ...
        k = filter.match(str1, str2, (String)localObject1, localUri, localSet, "LocalBroadcastManager");
        if (k >= 0)
        {
          if (i != 0)
          {
