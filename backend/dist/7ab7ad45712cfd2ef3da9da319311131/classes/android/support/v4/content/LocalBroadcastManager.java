      ...
      synchronized (mReceivers)
      {
        ...
        if ((paramIntent.getFlags() & 0x8) != 0)
        {
          ...
          if (i != 0)
          {
            ...
            Log.v("LocalBroadcastManager", "Resolving type " + (String)localObject1 + " scheme " + str2 + " of intent " + paramIntent);
          }
        ...
        k = filter.match(str1, (String)localObject1, str2, localUri, localSet, "LocalBroadcastManager");
        if (k >= 0)
        {
          if (i != 0)
          {
