  ...
  extends ViewGroup
{
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (localLayoutParams != null)
        {
          ...
          if (isDecor)
          {
            ...
            localView.measure(View.MeasureSpec.makeMeasureSpec(i4, m), View.MeasureSpec.makeMeasureSpec(i3, k));
            if (n == 0) {
              break label387;
            }
    ...
    if (mPageTransformer != null)
    {
      ...
      if (paramInt1 < j)
      {
        ...
        for (;;)
        {
          paramInt1++;
          break;
          paramFloat = (((View)localObject).getLeft() - paramInt2) / getWidth();
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (!mIsBeingDragged)
      {
        ...
        f4 = MotionEventCompat.getY(paramMotionEvent, k);
        f1 = Math.abs(f4 - mLastMotionY);
        if ((f3 > mTouchSlop) && (f3 > f1))
        {
          mIsBeingDragged = true;
      ...
      if (mIsBeingDragged)
      {
        ...
        i = getScrollX();
        localObject = infoForCurrentScrollPosition();
        setCurrentItemInternal(determineTargetPage(position, (i / m - offset) / widthFactor, j, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, mActivePointerId)) - mInitialMotionX)), true, true, j);
        mActivePointerId = -1;
        endDrag();
      ...
      if ((!mPopulatePending) && (getWindowToken() != null))
      {
        ...
        if (localObject4 != null)
        {
          ...
          if (m >= 0)
          {
            ...
            calculatePageOffsets((ItemInfo)localObject4, i1, (ItemInfo)localObject1);
          }
        }
        else
        {
        ...
        for (;;)
        {
          ...
          for (i2 = 0; i2 < i1; i2++)
          {
            ...
            {
              localObject4 = infoForChild((View)localObject3);
              if (localObject4 != null)
              {
            ...
            if (paramInt != 0) {
              mDrawingOrderedChildren.add(localObject3);
            }
          }
          paramInt++;
          break;
          ...
          if ((localObject2 != null) && (n == position))
          {
            f3 = f1 + widthFactor;
            i2 = m - 1;
            if (i2 >= 0) {}
          ...
          if ((localObject2 != null) && (i2 == position))
          {
            f3 = f1 + widthFactor;
            paramInt = n + 1;
            if (paramInt < mItems.size()) {}
  ...
  void smoothScrollTo(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt3 > 0) {}
    for (paramInt1 = Math.round(1000.0F * Math.abs((f2 + f3 * f1) / paramInt3)) * 4;; paramInt1 = (int)((1.0F + Math.abs(k) / (mPageMargin + f3 * f2)) * 100.0F))
    {
