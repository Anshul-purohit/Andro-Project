  ...
  extends FragmentManager
{
    ...
    for (;;)
    {
      ...
      if (mActive != null)
      {
        ...
        if (i < mActive.length)
        {
          ...
          {
            localFragment = localFragmentState.instantiate(mActivity, mParent);
            if (DEBUG) {
        ...
        if (paramArrayList != null)
        {
          ...
          if (i < paramArrayList.size())
          {
            ...
            for (mTarget = ((Fragment)mActive.get(mTargetIndex));; mTarget = null)
            {
              ...
              break;
              label448:
              Log.w("FragmentManager", "Re-attaching retained fragment " + localFragment + " target no longer exists: " + mTargetIndex);
            }
          }
        }
        if (mAdded != null)
  ...
  Parcelable saveAllState()
  {
    ...
    for (;;)
    {
      ...
      if (k < i)
      {
        ...
        {
          if (mIndex < 0) {
            throwException(new IllegalStateException("Failure saving state: active " + localObject2 + " has cleared index: " + mIndex));
          }
          m = 1;
          ...
          {
            if (mTarget.mIndex < 0) {
              throwException(new IllegalStateException("Failure saving state: " + localObject2 + " has target not in fragment manager: " + mTarget));
            }
            if (mSavedFragmentState == null) {
        ...
        if (mAdded != null)
        {
          ...
          if (j > 0)
          {
            ...
            for (k = 0;; k++)
            {
              ...
              if (localObject1[k] < 0) {
                throwException(new IllegalStateException("Failure saving state: active " + mAdded.get(k) + " has cleared index: " + localObject1[k]));
              }
              if (DEBUG) {
  ...
  public void setBackStackIndex(int paramInt, BackStackRecord paramBackStackRecord)
  {
    ...
    //   17: aload_0
    //   18: aload_3
    //   19: putfield 313	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   22: aload_0
    //   23: getfield 313	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   26: invokevirtual 311	java/util/ArrayList:size	()I
    //   29: istore 4
    //   31: iload 4
    //   33: istore 5
    //   35: iload_1
    //   36: iload 4
    //   38: if_icmpge +60 -> 98
    //   41: getstatic 95	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   44: ifeq +41 -> 85
    //   47: new 149	java/lang/StringBuilder
    //   50: astore_3
    //   51: aload_3
    //   52: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   55: ldc 42
    //   57: aload_3
    //   58: ldc_w 315
    //   61: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   64: iload_1
    //   65: invokevirtual 318	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   68: ldc_w 320
    //   71: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   74: aload_2
    //   75: invokevirtual 266	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   78: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   81: invokestatic 269	android/util/Log:v	(Ljava/lang/String;Ljava/lang/String;)I
    //   84: pop
    //   85: aload_0
    //   86: getfield 313	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   89: iload_1
    //   90: aload_2
    //   91: invokevirtual 337	java/util/ArrayList:set	(ILjava/lang/Object;)Ljava/lang/Object;
    //   94: pop
    //   95: aload_0
    //   96: monitorexit
    //   97: return
    ...
    //   104: aload_0
    //   105: getfield 313	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   108: aconst_null
    //   109: invokevirtual 254	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   112: pop
    //   113: aload_0
    //   114: getfield 307	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   117: ifnonnull +16 -> 133
    //   120: new 249	java/util/ArrayList
    //   123: astore_3
    //   124: aload_3
    //   125: invokespecial 250	java/util/ArrayList:<init>	()V
    //   128: aload_0
    //   129: aload_3
    //   130: putfield 307	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   133: getstatic 95	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   136: ifeq +32 -> 168
    //   139: new 149	java/lang/StringBuilder
    //   142: astore_3
    //   143: aload_3
    //   144: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   147: ldc 42
    //   149: aload_3
    //   150: ldc_w 1127
    //   153: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   156: iload 5
    //   158: invokevirtual 318	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   161: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   164: invokestatic 269	android/util/Log:v	(Ljava/lang/String;Ljava/lang/String;)I
    //   167: pop
    //   168: aload_0
    //   169: getfield 307	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   172: iload 5
    //   174: invokestatic 598	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   177: invokevirtual 254	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   180: pop
    //   181: iinc 5 1
    //   184: goto -86 -> 98
    //   187: getstatic 95	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   190: ifeq +41 -> 231
    //   193: new 149	java/lang/StringBuilder
    //   196: astore_3
    //   197: aload_3
    //   198: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   201: ldc 42
    //   203: aload_3
    //   204: ldc_w 331
    //   207: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   210: iload_1
    //   211: invokevirtual 318	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   214: ldc_w 333
    //   217: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   220: aload_2
    //   221: invokevirtual 266	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   224: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   227: invokestatic 269	android/util/Log:v	(Ljava/lang/String;Ljava/lang/String;)I
    //   230: pop
    //   231: aload_0
    //   232: getfield 313	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   235: aload_2
    //   236: invokevirtual 254	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   239: pop
    //   240: goto -145 -> 95
    //   243: astore_2
    //   244: aload_0
