  ...
  implements FragmentManager.BackStackEntry, Runnable
{
      ...
      for (Op localOp = mHead; localOp != null; localOp = next)
      {
        ...
        if (removed != null) {
          for (int i = removed.size() - 1; i >= 0; i--)
          {
            ...
            mBackStackNesting += paramInt;
            if (FragmentManagerImpl.DEBUG) {
              Log.v("BackStackEntry", "Bump nesting of " + localFragment + " to " + mBackStackNesting);
            }
          }
        }
      }
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    if (mHead != null)
    {
      ...
      for (paramFileDescriptor = mHead; paramFileDescriptor != null; paramFileDescriptor = next)
      {
        paramPrintWriter.print(paramString);
        ...
        if ((removed != null) && (removed.size() > 0))
        {
          ...
          if (i < removed.size())
          {
            ...
            for (;;)
            {
              paramPrintWriter.println(removed.get(i));
              i++;
              break;
  ...
  public CharSequence getBreadCrumbShortTitle()
  {
    ...
    for (CharSequence localCharSequence = mManager.mActivity.getText(mBreadCrumbShortTitleRes);; localCharSequence = mBreadCrumbShortTitleText) {
  ...
  public CharSequence getBreadCrumbTitle()
  {
    ...
    for (CharSequence localCharSequence = mManager.mActivity.getText(mBreadCrumbTitleRes);; localCharSequence = mBreadCrumbTitleText) {
      return localCharSequence;
    }
  }
      ...
      for (;;)
      {
        ...
        if (mManager.mAdded != null)
        {
          ...
          if (i < mManager.mAdded.size())
          {
            ...
            if (FragmentManagerImpl.DEBUG) {
              Log.v("BackStackEntry", "OP_REPLACE: adding=" + localObject1 + " old=" + localFragment);
            }
