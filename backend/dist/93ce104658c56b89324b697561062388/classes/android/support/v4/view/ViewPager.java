  ...
  extends ViewGroup
{
  ...
  private void recomputeScrollPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt2 > 0) && (!mItems.isEmpty()))
    {
      ...
      if (!mScroller.isFinished())
      {
        ...
        paramInt2 = mScroller.timePassed();
        localItemInfo = infoForPosition(mCurItem);
        mScroller.startScroll(paramInt4, 0, (int)(offset * paramInt1), 0, paramInt3 - paramInt2);
      }
      return;
    }
  ...
  public void fakeDragBy(float paramFloat)
  {
    ...
    Object localObject = (ItemInfo)mItems.get(mItems.size() - 1);
    if (position != 0) {
      paramFloat = offset * i;
    }
    if (position != mAdapter.getCount() - 1) {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (mIsBeingDragged)
      {
        ...
        j = getScrollX();
        localObject = infoForCurrentScrollPosition();
        setCurrentItemInternal(determineTargetPage(position, (j / m - offset) / widthFactor, i, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, mActivePointerId)) - mInitialMotionX)), true, true, i);
        mActivePointerId = -1;
        endDrag();
