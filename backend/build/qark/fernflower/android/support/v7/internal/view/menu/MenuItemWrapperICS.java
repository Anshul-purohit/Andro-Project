...
public class MenuItemWrapperICS extends BaseMenuWrapper implements SupportMenuItem {
   ...
   final boolean checkActionProviderOverrideVisibility() {
      ...
      if (this.mLastRequestVisible) {
         ...
         if (var3 != null) {
            var1 = var2;
            if (var3.overridesItemVisibility()) {
               var1 = var2;
               if (!var3.isVisible()) {
   ...
   public View getActionView() {
      View var2 = ((MenuItem)this.mWrappedObject).getActionView();
      View var1 = var2;
   ...
   public MenuItem setActionView(int var1) {
      ...
      if (var2 instanceof CollapsibleActionView) {
         ((MenuItem)this.mWrappedObject).setActionView(new MenuItemWrapperICS.CollapsibleActionViewWrapper(var2));
      }
   ...
   public MenuItem setActionView(View var1) {
      ...
      ((MenuItem)this.mWrappedObject).setActionView((View)var2);
      return this;
   }
