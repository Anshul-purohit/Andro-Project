...
class MenuWrapperICS extends BaseMenuWrapper implements SupportMenu {
   ...
   public int addIntentOptions(int var1, int var2, int var3, ComponentName var4, Intent[] var5, Intent var6, int var7, MenuItem[] var8) {
      ...
      var2 = ((Menu)this.mWrappedObject).addIntentOptions(var1, var2, var3, var4, var5, var6, var7, var9);
      if (var9 != null) {
         var1 = 0;
