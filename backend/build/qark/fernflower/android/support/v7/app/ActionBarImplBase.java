...
class ActionBarImplBase extends ActionBar {
   ...
   private void configureTab(ActionBar.Tab var1, int var2) {
      ActionBarImplBase.TabImpl var4 = (ActionBarImplBase.TabImpl)var1;
      if (var4.getCallback() == null) {
         ...
         while(var2 < var3) {
            ((ActionBarImplBase.TabImpl)this.mTabs.get(var2)).setPosition(var2);
            ++var2;
         }
   ...
   private void init(ActionBarActivity var1) {
      boolean var3 = false;
      this.mOverlayLayout = (ActionBarOverlayLayout)var1.findViewById(R$id.action_bar_overlay_layout);
      if (this.mOverlayLayout != null) {
         this.mOverlayLayout.setActionBar(this);
      }

      this.mActionView = (ActionBarView)var1.findViewById(R$id.action_bar);
      ...
      this.mTopVisibilityView = (ViewGroup)var1.findViewById(R$id.top_action_bar);
      ...
      if (this.mActionView != null && this.mContextView != null && this.mContainerView != null) {
         ...
         if (var4.enableHomeButtonByDefault() || var5) {
            var3 = true;
         }
   ...
   void animateToMode(boolean var1) {
      ...
      if (this.mTabScrollView != null && !this.mActionView.hasEmbeddedTabs() && this.mActionView.isCollapsed()) {
         ScrollingTabContainerView var6 = this.mTabScrollView;
         if (var1) {
            var2 = var3;
         } else {
            var2 = 0;
   ...
   public void doHide(boolean var1) {
      ...
      if (this.mTopVisibilityView.getVisibility() != 8) {
         ...
         Animation var3;
         if (var2) {
            var3 = AnimationUtils.loadAnimation(this.mContext, R$anim.abc_slide_out_top);
            this.mTopVisibilityView.startAnimation(var3);
         }

         this.mTopVisibilityView.setVisibility(8);
         if (this.mSplitView != null && this.mSplitView.getVisibility() != 8) {
            if (var2) {
               var3 = AnimationUtils.loadAnimation(this.mContext, R$anim.abc_slide_out_bottom);
   ...
   public void doShow(boolean var1) {
      ...
      if (this.mTopVisibilityView.getVisibility() != 0) {
         ...
         Animation var3;
         if (var2) {
            var3 = AnimationUtils.loadAnimation(this.mContext, R$anim.abc_slide_in_top);
            this.mTopVisibilityView.startAnimation(var3);
         }
         ...
         if (this.mSplitView != null && this.mSplitView.getVisibility() != 0) {
            if (var2) {
               var3 = AnimationUtils.loadAnimation(this.mContext, R$anim.abc_slide_in_bottom);
               this.mSplitView.startAnimation(var3);
            }
   ...
   public void removeTabAt(int var1) {
      if (this.mTabScrollView != null) {
         ...
         ActionBarImplBase.TabImpl var5 = (ActionBarImplBase.TabImpl)this.mTabs.remove(var1);
         if (var5 != null) {
            var5.setPosition(-1);
         }
         ...
         for(int var3 = var1; var3 < var4; ++var3) {
            ((ActionBarImplBase.TabImpl)this.mTabs.get(var3)).setPosition(var3);
         }
         ...
         if (var2 == var1) {
            if (this.mTabs.isEmpty()) {
               ...
               var5 = (ActionBarImplBase.TabImpl)this.mTabs.get(Math.max(0, var1 - 1));
            }
   ...
   public void setDisplayOptions(int var1, int var2) {
      ...
      this.mActionView.setDisplayOptions(var1 & var2 | ~var2 & var3);
   }
