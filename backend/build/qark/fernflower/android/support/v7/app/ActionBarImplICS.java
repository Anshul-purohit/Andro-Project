...
class ActionBarImplICS extends ActionBar {
   ...
   ActionBarImplICS(Activity var1, ActionBar.Callback var2, boolean var3) {
      ...
      if (var3 && (this.getDisplayOptions() & 4) != 0) {
   ...
   private ActionBarImplICS.OnMenuVisibilityListenerWrapper findAndRemoveMenuVisWrapper(ActionBar.OnMenuVisibilityListener var1) {
      int var3;
      for(int var2 = 0; var2 < this.mAddedMenuVisWrappers.size(); var2 = var3 + 1) {
         ActionBarImplICS.OnMenuVisibilityListenerWrapper var4 = (ActionBarImplICS.OnMenuVisibilityListenerWrapper)((WeakReference)this.mAddedMenuVisWrappers.get(var2)).get();
         if (var4 == null) {
            this.mAddedMenuVisWrappers.remove(var2);
            var3 = var2 - 1;
         } else {
            var3 = var2;
            if (var4.mWrappedListener == var1) {
               this.mAddedMenuVisWrappers.remove(var2);
               return var4;
            }
         }
   ...
   ImageView getHomeActionView() {
      if (this.mHomeActionView == null) {
         ...
         var1 = var2.getChildAt(0);
         View var3 = var2.getChildAt(1);
         if (var1.getId() == 16908332) {
            var1 = var3;
         }

         if (var1 instanceof ImageView) {
            this.mHomeActionView = (ImageView)var1;
         }
      }
   ...
   public ActionBar.Tab newTab() {
      android.app.ActionBar.Tab var1 = this.mActionBar.newTab();
   ...
   public void setCustomView(View var1, ActionBar.LayoutParams var2) {
      android.app.ActionBar.LayoutParams var3 = new android.app.ActionBar.LayoutParams(var2);
   ...
   public void setHomeAsUpIndicator(Drawable var1) {
      ImageView var3 = this.getHomeActionView();
      if (var3 != null) {
         Drawable var2 = var1;
         if (var1 == null) {
            var2 = this.getThemeDefaultUpIndicator();
         }
   ...
   class TabWrapper extends ActionBar.Tab implements android.app.ActionBar.TabListener {
      ...
      public TabWrapper(android.app.ActionBar.Tab var2) {
      ...
      public void onTabReselected(android.app.ActionBar.Tab var1, android.app.FragmentTransaction var2) {
      ...
      public void onTabSelected(android.app.ActionBar.Tab var1, android.app.FragmentTransaction var2) {
         ActionBar.TabListener var3 = this.mTabListener;
         FragmentTransaction var4;
         if (var2 != null) {
            var4 = ActionBarImplICS.this.getActiveTransaction();
      ...
      public void onTabUnselected(android.app.ActionBar.Tab var1, android.app.FragmentTransaction var2) {
         ActionBar.TabListener var3 = this.mTabListener;
         FragmentTransaction var4;
         if (var2 != null) {
            var4 = ActionBarImplICS.this.getActiveTransaction();
      ...
      public ActionBar.Tab setTabListener(ActionBar.TabListener var1) {
         ...
         android.app.ActionBar.Tab var2 = this.mWrappedTab;
