...
final class BakedBezierInterpolator implements Interpolator {
   ...
   public float getInterpolation(float var1) {
      if (var1 >= 1.0F) {
         ...
         int var2 = Math.min((int)((float)(VALUES.length - 1) * var1), VALUES.length - 2);
         var1 = (var1 - (float)var2 * STEP_SIZE) / STEP_SIZE;
         return VALUES[var2] + (VALUES[var2 + 1] - VALUES[var2]) * var1;
      }
   }
}
