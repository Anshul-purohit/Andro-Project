        ...
        while (op != null) {
            ...
            if (bl) {
                if (op.enterAnim != 0 || op.exitAnim != 0) {
                    ...
                    printWriter.print(Integer.toHexString((int)op.enterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString((int)op.exitAnim));
                }
                if (op.popEnterAnim != 0 || op.popExitAnim != 0) {
                    printWriter.print(string2);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString((int)op.popEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString((int)op.popExitAnim));
                }
            }
