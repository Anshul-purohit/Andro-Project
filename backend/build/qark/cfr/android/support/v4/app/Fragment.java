...
View.OnCreateContextMenuListener {
    ...
    public static Fragment instantiate(Context object, String string2, Bundle bundle) {
        try {
            ...
            throw new InstantiationException("Unable to instantiate fragment " + string2 + ": make sure class name exists, is public, and has an" + " empty constructor that is public", (Exception)classNotFoundException);
        }
        catch (java.lang.InstantiationException instantiationException) {
            throw new InstantiationException("Unable to instantiate fragment " + string2 + ": make sure class name exists, is public, and has an" + " empty constructor that is public", (Exception)instantiationException);
        }
        catch (IllegalAccessException illegalAccessException) {
            throw new InstantiationException("Unable to instantiate fragment " + string2 + ": make sure class name exists, is public, and has an" + " empty constructor that is public", (Exception)illegalAccessException);
        }
    }
    ...
    void performReallyStop() {
        block6 : {
            block5 : {
                ...
                if (this.mActivity.mRetaining) break block6;
