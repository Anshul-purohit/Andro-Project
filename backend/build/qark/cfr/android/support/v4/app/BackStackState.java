...
implements Parcelable {
    ...
    public BackStackState(FragmentManagerImpl object, BackStackRecord backStackRecord) {
        ...
        do {
            ...
            if (object.removed != null) {
                ...
                n2 = n4 + 1;
                for (n = 0; n < n3; ++n, ++n2) {
                    this.mOps[n2] = ((Fragment)object.removed.get((int)n)).mIndex;
                }
            } else {
                arrn = this.mOps;
                n2 = n4 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        do {
            ...
            object = this.mOps;
            n = n3 + 1;
            op.fragment = (n3 = object[n3]) >= 0 ? (Fragment)fragmentManagerImpl.mActive.get(n3) : null;
            object = this.mOps;
            n3 = n + 1;
            ...
            if (n5 > 0) {
                ...
                do {
                    ...
                    object = (Fragment)fragmentManagerImpl.mActive.get(this.mOps[n]);
                    op.removed.add(object);
                    ++n4;
                    ++n;
                } while (true);
            }
