...
public class TextDirectionHeuristicsCompat {
    ...
    implements TextDirectionAlgorithm {
        ...
        public int checkRtl(CharSequence charSequence, int n, int n2) {
            ...
            block4 : for (int i = n; i < n + n2; ++i) {
                switch (TextDirectionHeuristicsCompat.isRtlText(Character.getDirectionality((char)charSequence.charAt(i)))) {
                    case 0: {
                        if (this.mLookForRtl) {
                            return 0;
                        }
    ...
    implements TextDirectionAlgorithm {
        ...
        public int checkRtl(CharSequence charSequence, int n, int n2) {
            ...
            for (int i = n; i < n + n2 && n3 == 2; ++i) {
                n3 = TextDirectionHeuristicsCompat.isRtlTextOrFormat(Character.getDirectionality((char)charSequence.charAt(i)));
            }
            return n3;
        }
    }
    ...
    implements TextDirectionHeuristicCompat {
        ...
        public boolean isRtl(char[] arrc, int n, int n2) {
            return this.isRtl((CharSequence)CharBuffer.wrap((char[])arrc), n, n2);
        }
    }
