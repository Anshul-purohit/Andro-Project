...
public class GestureDetectorCompat {
    ...
    implements GestureDetectorCompatImpl {
        ...
        private boolean isConsideredDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, MotionEvent motionEvent3) {
            int n;
            int n2;
            if (!this.mAlwaysInBiggerTapRegion || motionEvent3.getEventTime() - motionEvent2.getEventTime() > (long)DOUBLE_TAP_TIMEOUT || (n = (int)motionEvent.getX() - (int)motionEvent3.getX()) * n + (n2 = (int)motionEvent.getY() - (int)motionEvent3.getY()) * n2 >= this.mDoubleTapSlopSquare) {
                return false;
            }
            return true;
        }
        ...
        public boolean onTouchEvent(MotionEvent var1_1) {
            ...
            switch (var10_2 & 255) {
                ...
                case 2: {
                    ...
                    if (Math.abs((float)var4_13) < 1.0f) {
                        var12_12 = var11_11;
                        if (Math.abs((float)var5_14) < 1.0f) return var12_12;
                    }
                    var11_11 = this.mListener.onScroll(this.mCurrentDownEvent, var1_1, var4_13, var5_14);
                    this.mLastFocusX = var3_5;
                    this.mLastFocusY = var2_6;
...
lbl132: // 1 sources:
                    ...
                    if (Math.abs((float)var2_6) > (float)this.mMinimumFlingVelocity) ** GOTO lbl140
                    var11_11 = var14_10;
                    if (Math.abs((float)var3_5) <= (float)this.mMinimumFlingVelocity) ** GOTO lbl141
lbl140: // 2 sources:
