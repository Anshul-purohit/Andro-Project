...
abstract class AdapterViewICS<T extends Adapter> extends ViewGroup
{
    ...
    {
        void onItemClick(final AdapterViewICS<?> p0, final View p1, final int p2, final long p3);
    }
    ...
    {
        boolean onItemLongClick(final AdapterViewICS<?> p0, final View p1, final int p2, final long p3);
    }
    
    public interface OnItemSelectedListener
    {
        void onItemSelected(final AdapterViewICS<?> p0, final View p1, final int p2, final long p3);
        
        void onNothingSelected(final AdapterViewICS<?> p0);
    }
