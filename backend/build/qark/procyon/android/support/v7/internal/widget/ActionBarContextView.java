...
public class ActionBarContextView extends AbsActionBarView
{
    ...
    protected void onMeasure(int i, int b) {
        ...
        if (this.mCustomView != null) {
            ...
            this.mCustomView.measure(View$MeasureSpec.makeMeasureSpec(b, i), View$MeasureSpec.makeMeasureSpec(min, n3));
        }
        if (this.mContentHeight <= 0) {
            b = 0;
            int childCount;
            int n4;
            int n5;
            for (childCount = this.getChildCount(), i = 0; i < childCount; ++i, b = n5) {
                n4 = this.getChildAt(i).getMeasuredHeight() + n2;
                if (n4 > (n5 = b)) {
                    n5 = n4;
                }
            }
