...
abstract class AbsSpinnerICS extends AdapterViewICS<SpinnerAdapter>
{
    ...
    protected void onMeasure(final int mWidthMeasureSpec, final int mHeightMeasureSpec) {
        ...
        this.setMeasuredDimension(resolveSize(Math.max(a2, this.getSuggestedMinimumWidth()), mWidthMeasureSpec), resolveSize(Math.max(a, this.getSuggestedMinimumHeight()), mHeightMeasureSpec));
