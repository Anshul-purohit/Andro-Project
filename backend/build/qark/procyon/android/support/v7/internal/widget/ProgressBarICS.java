        ...
        if (this.mIndeterminateDrawable != null) {
            ...
            if (this.mOnlyIndeterminate) {
                ...
                if (!(this.mIndeterminateDrawable instanceof AnimationDrawable)) {
                    final float n9 = this.mIndeterminateDrawable.getIntrinsicWidth() / (float)this.mIndeterminateDrawable.getIntrinsicHeight();
                    final float n10 = n / (float)n2;
                    n5 = n4;
                    n7 = (b2 ? 1 : 0);
                    n6 = n3;
                    n8 = (b ? 1 : 0);
