...
abstract class ActionBarActivityDelegate
{
    ...
    private class ActionBarDrawableToggleImpl implements Delegate
    {
        ...
        public Drawable getThemeUpIndicator() {
            final TypedArray obtainStyledAttributes = ActionBarActivityDelegate.this.mActivity.obtainStyledAttributes(new int[] { ActionBarActivityDelegate.this.getHomeAsUpIndicatorAttrId() });
