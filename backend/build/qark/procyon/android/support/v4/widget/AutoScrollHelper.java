    ...
    private static class ClampedScroller
    {
        ...
        private float getValueAt(final long n) {
            ...
            if (this.mStopTime < 0L || n < this.mStopTime) {
                return constrain((n - this.mStartTime) / (float)this.mRampUpDuration, 0.0f, 1.0f) * 0.5f;
            }
            return constrain((n - this.mStopTime) / (float)this.mEffectiveRampDown, 0.0f, 1.0f) * this.mStopValue + (1.0f - this.mStopValue);
        }
